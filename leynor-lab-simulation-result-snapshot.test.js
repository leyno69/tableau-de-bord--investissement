...
test('refuse un instantané sans percentiles', () => {
  assert.throws(() => createSimulationResultSnapshot({ snapshotId: 's', campaignId: 'c', executionId: 'e', seedPlanId: 'p', generatedAt: 't', completedRuns: 1, finalValueMean: 1, returnMean: 0, volatilityMean: 0, maxDrawdownMean: 0, lossFrequency: 0, recoveryDurationMean: 0, goalProbability: 0, percentiles: {} }));
});
